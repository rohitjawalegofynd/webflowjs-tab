...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        var j = e.frame = function() {
            ...
            B = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (j(n), e = q(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = q()), this.active = !0, t = this, 1 === u.push(t) && j(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        C.transform && (K.transform = [D], Z = {
            ...
            skewX: [k],
            skewY: [k]
        }), C.transform && C.backface && (Z.z = [x, "translateZ"], Z.rotateZ = [k], Z.scaleZ = [b], Z.perspective = [y]);
        var Q = /ms/,
            V = /s|\./;
        return t.tram = e
    }(window.jQuery)
